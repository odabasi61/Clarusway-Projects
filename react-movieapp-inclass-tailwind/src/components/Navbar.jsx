...
const Navbar = () => {
  ...
  // aşağıdaki currentuser, firebaseden veri almadan önce bizim manuel olarak oluşturduğumuz currentuser. burada currentuser ve logout authcontextten çekildi.
